    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                ...
                // Son İşlemler Başlığı ve Listesi
                VStack(alignment: .leading) {
                    Text("Son İşlemler")
                        .font(.title2)
                        .bold()
                    ...
                    if portfolioViewModel.transactions.isEmpty {
                        Text("Henüz bir işlem yapmadınız.")
                            .foregroundColor(.gray)
                            .padding()
                    } else {
                        // Ana sayfa çok uzamasın diye prefix(5) ile sadece son 5 işlemi gösteriyoruz
                        ForEach(portfolioViewModel.transactions.prefix(5)) { islem in
                            HStack {
            ...
            .onAppear {
                ...
                portfolioViewModel.fetchTransactions()
            }
        }
    }
}
